...
import com.jspark.zerobase_project02.dto.AccountDto;
...
import static com.jspark.zerobase_project02.type.ErrorCode.ACCOUNT_ALREADY_UNREGISTERED;
...
class AccountServiceTest {
    ...
    void createAccount_UserNofFound() {
        //given
        given(accountUserRepository.findById(anyLong()))
                .willReturn(Optional.empty());
        //when
    ...
    void deleteAccount_UserNofFound() {
        //given
        given(accountUserRepository.findById(anyLong()))
                .willReturn(Optional.empty());
        //when
    ...
    @Test
    @DisplayName("해당 유저 없음 - 계좌정보 조회 실패")
